...
void LBM2dPlates::collide_corner1(){
	...
	//2,5,6
	lattice->f[1][i0][j0]=lattice->f[1][i1][j1];//periodic boundary conditions
	lattice->f[8][i0][j0]=lattice->f[8][i1][j1];
	...
	//
	//i=lattice->nx+1;j=0;
	lattice->f[3][i1][j1]=lattice->f[3][i0][j0];//periodic boundary conditions
	lattice->f[7][i1][j1]=lattice->f[7][i0][j0];
	...
	lattice->f[1][i0][j0]=lattice->f[1][i1][j1];//periodic boundary conditions
	lattice->f[5][i0][j0]=lattice->f[5][i1][j1];
	...
	//
	lattice->f[3][i1][j1]=lattice->f[3][i0][j0];//periodic boundary conditions
	lattice->f[6][i1][j1]=lattice->f[6][i0][j0];
	rhow=lattice->f[0][i1][j1]+lattice->f[1][i1][j1]+lattice->f[3][i1][j1]
